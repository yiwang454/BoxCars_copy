...
def predictions_for_img(model, image):
    '''
    ...
    return model.predict_on_batch(image_predict)
...
if __name__ == '__main__':
    ...
    image = cv2.imread('/home/vivacityserver6/repos/BoxCars/ims/cropped_img/img_1_0_car.jpg')
    prediction = predictions_for_img(model, image)
    print(prediction[1].tolist()[0])
